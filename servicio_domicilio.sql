...
--
-- Host: localhost    Database: servicio_domicilios
-- ------------------------------------------------------
...
CREATE TABLE `pedido` (
  ...
  `lugar_pedido` varchar(100) DEFAULT NULL,
  `lugar_destino` varchar(100) DEFAULT NULL,
...
-- Dump completed on 2025-07-30 20:37:30
