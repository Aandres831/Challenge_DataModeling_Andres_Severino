...
CREATE TABLE `paquete_destino` (
  `id_paquete_destino` int NOT NULL AUTO_INCREMENT,
  `id_paquete` int DEFAULT NULL,
  `id_destino` int DEFAULT NULL,
  `fecha_programada` date DEFAULT NULL,
  PRIMARY KEY (`id_paquete_destino`),
  KEY `id_paquete` (`id_paquete`),
  KEY `id_destino` (`id_destino`),
  CONSTRAINT `paquete_destino_ibfk_1` FOREIGN KEY (`id_paquete`) REFERENCES `paquete` (`id_paquete`),
  CONSTRAINT `paquete_destino_ibfk_2` FOREIGN KEY (`id_destino`) REFERENCES `destino` (`id_destino`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `paquete_destino` WRITE;
...
-- Dump completed on 2025-07-30 20:27:02
